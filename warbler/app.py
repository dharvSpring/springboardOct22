...
def profile():
    ...
    if profile_form.validate_on_submit():
        if User.authenticate(g.user.username, profile_form.password.data):
            g.user.username = profile_form.username.data
            g.user.email = profile_form.email.data
            g.user.image_url = profile_form.image_url.data or "/static/images/default-pic.png"
            g.user.header_image_url = profile_form.header_image_url.data or "/static/images/warbler-hero.jpg"
            g.user.location = profile_form.location.data
            g.user.bio = profile_form.bio.data
...
def homepage():
    ...
    if g.user:
        followed_users =  [g.user.id] + [u.id for u in g.user.following]
        messages = (Message
                    .query
